...
const setSMTP = async (req, res) => {
    ...
    if(email == null | smtpHost == null || smtpPort == null || smtpUsername == null || smtpPassword == null) {
        config.setSMTP([email, smtpHost, smtpPort, smtpUsername, smtpPassword], (err, data) => {
            if (err) {
                res.sendStatus(500);
            } else {
                SMTP_EMAIL = email;
